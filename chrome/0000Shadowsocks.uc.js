...
function    UPGae() { gBrowser.mPrefs.setIntPref("network.proxy.type","0"); var file = FileUtils.getFile('UChrm',['Batch', 'update-GAE.bat']).launch();};
