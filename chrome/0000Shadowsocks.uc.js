...
function    RunSSjp2() { gBrowser.mPrefs.setIntPref("network.proxy.type","0"); gBrowser.loadURI("http://www.shadowsocks8.com/images/server03.png"); };

function    RunSSus2() { gBrowser.mPrefs.setIntPref("network.proxy.type","0"); gBrowser.loadURI("http://www.shadowsocks8.com/images/server01.png"); };

function    RunSShk2() { gBrowser.mPrefs.setIntPref("network.proxy.type","0"); gBrowser.loadURI("http://www.shadowsocks8.com/images/server02.png"); };
